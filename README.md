...
#### پروتکل‌ها و اتصال
- **Smart Connect** (اتصال هوشمند): تست خودکار همه پروتکل‌ها و انتخاب سریع‌ترین و پایدارترین مسیر
- **WireGuard**: اتصال پایدار با IP ثابت
...
#### حالت‌های اتصال
- **Device VPN** (وی‌پی‌ان کل دستگاه)
- **SOCKS5 Proxy** (پروکسی محلی)
- **Smart Connect**
...
- **LAN Sharing**: اشتراک‌گذاری پروکسی برای دستگاه‌های دیگر در شبکه محلی
...
- انیمیشن‌های مدرن (Connection Orb، Sparkline ترافیک، Shimmer)
...
- معرفی برنامه Film Baran (بیش از ۴۰ هزار فیلم و سریال رایگان)
...
### نصب
فایل APK از پوشه `app/release` در همین ریپازیتوری قابل دانلود است:
- `Baran vpn v 2.2.0 All device.apk`
...
### Introduction
**Baran VPN** is a powerful, free Android VPN client focused on censorship circumvention. It is built around the **Psiphon** core and supports modern protocols including WireGuard, Cloudflare WARP, MASQUE, and Tor. It features a modern UI, full Persian & English support, Split Tunneling, Kill Switch, and many advanced options.

### Features (Complete List)

#### Protocols & Connection
- **Smart Connect**: Automatically tests all protocols and picks the fastest reliable route
- **WireGuard**: Stable connection, IP remains unchanged
...
- **LAN Sharing**: share the SOCKS5 proxy with other devices on your local network
- HTTP CONNECT proxy support (port 8080 when LAN sharing is enabled)

#### UI & UX
- Dark theme by default
- Persian & English languages
- Modern animations (Connection Orb, traffic sparklines, shimmer)
...
- Promotion of Film Baran app (40,000+ free movies & series)
...
### Installation
Download the APK from the `app/release` folder in this repository:
- `Baran vpn v 2.2.0 All device.apk`
