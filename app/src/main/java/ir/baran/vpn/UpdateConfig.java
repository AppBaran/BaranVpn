...
final class UpdateConfig {
    static final String API_URL = "https://api.github.com/repos/appFilmBaran/AetherGUI/releases?per_page=30";
    static final String RELEASE_ASSET = "Aethon-VPN-v%s-Android-Universal.apk";
    static final String CHECKSUM_ASSET = "SHA256SUMS.txt";
    static final String RELEASE_DOWNLOAD_PREFIX = "https://github.com/appFilmBaran/AetherGUI/releases/download/";
    ...
    static final String ACTION_STATE = "ir.baran.vpn.UPDATE_STATE";
    static final String ACTION_DOWNLOAD = "ir.baran.vpn.DOWNLOAD_UPDATE";
    static final String ACTION_INSTALL = "ir.baran.vpn.INSTALL_UPDATE";
